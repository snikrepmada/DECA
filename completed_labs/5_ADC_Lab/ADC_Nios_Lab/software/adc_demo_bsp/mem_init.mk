...
# Memory: NiosSubsystem_nios_memory
MEM_0 := adc_qsys_NiosSubsystem_nios_memory
$(MEM_0)_NAME := NiosSubsystem_nios_memory
...
$(MEM_0)_HIERARCHICAL_PATH := NiosSubsystem.nios_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: NiosSubsystem_nios_memory
NiosSubsystem_nios_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
