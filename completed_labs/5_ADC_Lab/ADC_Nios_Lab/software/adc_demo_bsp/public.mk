...
# CPU Name 
# setting CPU_NAME is NiosSubsystem_nios2_gen2
CPU_NAME = NiosSubsystem_nios2_gen2
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x51020
SOPC_SYSID_FLAG += --sidp=0x51020
ELF_PATCH_FLAG  += --sidp 0x51020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1429665498
SOPC_SYSID_FLAG += --timestamp=1429665498
ELF_PATCH_FLAG  += --timestamp 1429665498
...
# setting hal.stderr is NiosSubsystem_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev NiosSubsystem_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is NiosSubsystem_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev NiosSubsystem_jtag_uart
...
# setting hal.stdout is NiosSubsystem_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev NiosSubsystem_jtag_uart
