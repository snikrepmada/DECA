...
$(MEM_0)_START := 0x01440000
$(MEM_0)_END := 0x014657ff
...
$(MEM_1)_END := 0x0135ffff
$(MEM_1)_SPAN := 0x00160000
$(MEM_1)_HIERARCHICAL_PATH := ufm_flash
$(MEM_1)_WIDTH := 32
...
.PHONY: ufm_flash
ufm_flash: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym $(MEM_1).flash
