...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../usb20sr_refdes.sopcinfo
...
# CPU Name 
# setting CPU_NAME is cpu_qsys_gen2
CPU_NAME = cpu_qsys_gen2
...
# Design Name 
# setting SOPC_NAME is usb20sr_refdes
SOPC_NAME := usb20sr_refdes
...
# The SOPC System ID 
# setting SOPC_SYSID is 233612565
SOPC_SYSID_FLAG += --id=233612565
ELF_PATCH_FLAG  += --id 233612565
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1429780595
SOPC_SYSID_FLAG += --timestamp=1429780595
ELF_PATCH_FLAG  += --timestamp 1429780595
